...
class SettingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<SettingViewModel>(builder: (context, state, _) {
                          ...
                          Padding(
                            ...
                            child: Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                child: const Text('shared_preferences 초기화 버튼',
                                    style: TextStyle(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              if (selectedDate != null) {
                                final findDate = DateUtility.findStartDay(
                                    selectedDate,
                                    helper.getWeekStartDay() ?? 1);
                                log("$findDate");

                                state.serverReset(helper.getStoreId()!, findDate);
                                delete.deleteLocalSchedule();
                              }
                            },
                            child: const Text('서버 데이터 삭제 (전시용)',
          ...
          TextButton(
            onPressed: () {
              ...
              Navigator.pushAndRemoveUntil(
                  context,
                  MaterialPageRoute(builder: (context) => CheckLoginScreen()),
                  (route) => false);
            },
            child: const Text('OK'),
          ),
